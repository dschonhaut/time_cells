...
def load_spikes(subj_sess, neuron, proj_dir="/home1/dscho/projects/time_cells"):
...
def roi_lookup(subj_sess, chan, proj_dir="/home1/dscho/projects/time_cells"):
...
def get_montage(subj_sess, proj_dir="/home1/dscho/projects/time_cells"):
